...
struct gmp_hdr_t : public subfile_hdr_t
{
    gmp_hdr_t()
    {
        memset(this, 0, sizeof(gmp_hdr_t));
        memcpy(type, "GARMIN GMP", 10);
    }

...
CKeyGen::CKeyGen(quint32 mapId, qint32 sizeHdrTre)
    : mapId(mapId)
    , sizeHdrTre(sizeHdrTre)
{
}
...
{
    constexpr quint8 mapIdCodeTable[] = {
        0, 1, 0xf, 5,
        0xd, 4, 7, 6,
        0xb, 9, 0xe, 8,
        2, 0xa, 0xc, 3
...
void CKeyGen::calcFourth()
{
    memcpy(values[3], values[2], sizeof(values[3]));
}

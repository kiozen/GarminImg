...
CLinePreparer::CLinePreparer(const CPolyline& line, const CSubdiv& subdiv) : polyline(line), subdiv(subdiv) {
  extraBit = line.isRoad() && subdiv.zoom() == 0 && (line.hasInternalNodes() || !line.isLastSegment());

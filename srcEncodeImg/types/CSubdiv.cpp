...
CSubdiv::CSubdiv(const CMapLevel &maplevel, quint16 n, qreal northbound, qreal eastbound, qreal southbound, qreal westbound)
...
//    CGarminPolygon p;
//    p.decode2(center_.getLongitude(), center_.getLatitude(), shift_, false, (const quint8*)data.data(), (const quint8*)data.data() + data.size());
}
